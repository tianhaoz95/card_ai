...
- settings screen: the settings screen should have buttons for sign out, delete the account and switch between languages, download model for llm inference.
