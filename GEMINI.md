- The Firebase project ID for the application is 'card-ai-app'.
...
- To find instructions for using cactus LLM inference engine, see https://www.cactuscompute.com/docs/flutter.